...
urlpatterns = [
    ...
    path(
        "google-login-url/", api_views.api_google_login_url, name="api-google-login-url"
    ),
    path(
        "resend-verification/",
        api_views.api_resend_verification,
        name="api-resend-verification",
    ),
    path("forgot-password/", api_views.api_forgot_password, name="api-forgot-password"),
    path(
        "verify-reset-token/<uidb64>/<token>/",
        api_views.api_verify_reset_token,
        name="api-verify-reset-token",
    ),
    path(
        "reset-password/<uidb64>/<token>/",
        api_views.api_reset_password,
    ...
    path(
        "relinquish-tree/<str:tree_id>/",
        api_views.api_relinquish_tree,
        name="api-relinquish-tree",
    ),
]
